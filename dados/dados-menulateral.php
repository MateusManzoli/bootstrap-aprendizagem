...
<div class="video" align="center">
    <video controls="controls" poster="../../imagens/hojeEuToTerrivel.jpg">
        <source src="../../_media/cristianoAraujo.mp4" type="video/mp4"/>
    </video>
</div>

<!-- feed noticias twitter -->
<?php if (!empty($_SESSION['logado'])) { ?>
                <a class="twitter-timeline"  href="https://twitter.com/search?q=%40avianca" data-widget-id="672845064889049088">Tweets sobre @avianca</a>
