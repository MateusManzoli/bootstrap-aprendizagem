            ...
            <div class="col-md-4">
                <div class="thumbnail" >
                    <a href="../../public/noticias/noticia.php?id=<?php echo $noticia['id'] // o link sera diferente de acordo com o id    ?>"> <img src="../../imagens/<?php echo $noticia['imagem']; // seleciona a imagem de cada id    ?>"/>
                        <div class="caption">
                            <h4><?php echo substr($noticia['manchete'], 0, 49) //busca a manchete | SUBSTR define a quantidade de caracteres    ?></h4>
                            <p><?php echo substr($noticia['subtitulo'], 0, 66)//busca o subtitulo   ?></p>
                        </div>
                    </a>
                </div>
            </div>
