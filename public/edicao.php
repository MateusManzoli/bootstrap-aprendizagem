            ...
            <form class="form-horizontal-a" method="post" action="edicao.php?id=<?php echo $_GET['id']; ?>"> 
                ...
                <div class="form-group-a">
                    ...
                    <div class="col-sm-10-a">
                        <input name="publicacao" type="text" class="form-control" maxlength="150" value="<?php echo $noticia['publicacao']; ?>">
                    </div>
                </div>
                ...
                <div class="form-group-a">
                    ...
                    <div class="col-sm-10-a">
                        <input  name="manchete" type="text" class="form-control" id="inputEmail3" maxlength="255" value="<?php echo $noticia['manchete'] ?>"> 
                    </div>
                </div>
